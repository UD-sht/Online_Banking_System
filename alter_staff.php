...
$status=  mysqli_real_escape_string($conn,$_REQUEST['edit_status']);
$dept=  mysqli_real_escape_string($conn,$_REQUEST['edit_dept']);
$doj=  mysqli_real_escape_string($conn,$_REQUEST['edit_doj']);
