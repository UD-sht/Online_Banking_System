...
$nominee=  mysqli_real_escape_string($conn,$_REQUEST['customer_nominee']);
$type=  mysqli_real_escape_string($conn,$_REQUEST['customer_account']);
...
$date=date("Y-m-d");
switch($branch){
case 'KATHMANDU': $ifsc="K421A";
    break;
case 'LALITPUR': $ifsc="D30AC";
    break;
case 'BHAKTAPUR': $ifsc="B6A9E";
    break;
}
